# Detection-of-epilepsy-from-EEG-data-using-ML-algorithms
Developed and tested different algorithms that classify patients into two groups (normal and epileptic) on the basis of their EEG data with good accuracy
# Description
